...
<br>
          <div class="form-caption flex items-end justify-center text-center space-x-3 mb-20">
            ...
            <span class="text-3xl font-semibold text-gray-700">Register</span>
          </div>
          <!-- form caption -->
          <form method="POST" action="{{ route('postsignup') }}">
            ...
            <div class="form-element">
                <label class="space-y-2 w-full lg:w-4/5 block mx-auto">
                  <span class="block text-lg text-gray-800 tracking-wide">nama</span>
                  <span class="block">
                    <input type="name" placeholder="Enter your nama" id="name" class="bg-yellow-100 lg:bg-white border lg:border-2 border-gray-400 lg:border-gray-200 w-full p-3 focus:outline-none active:outline-none focus:border-gray-400 active:border-gray-400" name="name">
                    @if ($errors->has('name'))
                    <script>
                        swal({
                            title: 'Error',
          ...
          <div class="form-element">
            <label class="space-y-2 w-full lg:w-4/5 block mx-auto">
              <span class="block text-lg text-gray-800 tracking-wide">Repeat Password</span>
              <span class="block">
            <input type="password"  class="bg-yellow-100 lg:bg-white border lg:border-2 border-gray-400 lg:border-gray-200 w-full p-3 focus:outline-none active:outline-none focus:border-gray-400 active:border-gray-400" name="password_confirmation"
                id="password_confirmation" placeholder="Repeat Password" required oninput="check(this)"
                class="form-control">
