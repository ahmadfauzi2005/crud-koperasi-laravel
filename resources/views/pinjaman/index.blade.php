...
<body>
        ...
        <div class="container">
          ...
          <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="pinjaman">pinjaman</a>
              </li>
              </li> &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            <li class="nav-item">
    ...
    @endif
                            <!-- Page Heading -->
                                ...
                                <a href="{{ route('pinjaman.create') }}" class="btn btn-md btn-success mb-3">TAMBAH DATA</a>
                                ...
                                <tbody>
                                @forelse ($pinjamanns as $pinjaman)
                                <tr>
                                <td>{{ $pinjaman->kode }}</td>
                                ...
                                <td class="text-center">
                                    <form id="delete-form-{{ $pinjaman->id }}" action="{{ route('pinjaman.destroy', $pinjaman->id) }}" method="POST">
                                        <a href="{{ route('pinjaman.edit', $pinjaman->id) }}" class="btn btn-sm btn-primary">EDIT</a>
                                        @csrf
                                        @method('DELETE')
                                        <button type="button" class="btn btn-sm btn-danger" onclick="deletepinjaman({{ $pinjaman->id }})">HAPUS</button>
                                        @if (session('status'))
                                            <script>
                                                Swal.fire({
