      ...
      <div class="form-wrapper flex items-center lg:h-full px-10 relative z-10 pt-16 lg:pt-0">
        <div class="w-full space-y-5">
          ...
          <div class="form-caption flex items-end justify-center text-center space-x-3 mb-20">
            ...
            <span class="text-3xl font-semibold text-gray-700">Lupa password</span>
          </div>
          <!-- form caption -->
          ...
          <div class="form-element">
            <label class="space-y-2 w-full lg:w-4/5 block mx-auto">
              ...
              <span class="block">
                <input type="text" placeholder="Enter your Email" name="email" id="email" class="bg-yellow-100 lg:bg-white border lg:border-2 border-gray-400 lg:border-gray-200 w-full p-3 focus:outline-none active:outline-none focus:border-gray-400 active:border-gray-400" name="email"
                                     autofocus>
                                @if ($errors->has('email'))
                                <script>
                                    swal({
          ...
          <div class="form-element">
            <label class="space-y-2 w-full lg:w-4/5 block mx-auto">
              ...
              <span class="block">
                <input type="password" placeholder="Enter your Password" name="password" id="password" class="bg-yellow-100 lg:bg-white border lg:border-2 border-gray-400 lg:border-gray-200 w-full p-3 focus:outline-none active:outline-none focus:border-gray-400 active:border-gray-400" name="password">
                ...
                @endif
                      ...
                      <span class="block text-lg text-gray-800 tracking-wide">Konfirmasi Password</span>
                      <span class="block">
                        <input type="password" name="konfirmasi" placeholder="Enter your konfirmasi Password" id="password" class="bg-yellow-100 lg:bg-white border lg:border-2 border-gray-400 lg:border-gray-200 w-full p-3 focus:outline-none active:outline-none focus:border-gray-400 active:border-gray-400" name="password">
        ...
        <script>
          const passwordInput = document.getElemenById('password');
          const passwordConfirmInput = document.getElemenById('password_confirm');
          const passwordConfrimError = document.getElemenById('password-confirm-error');

          passwordConfirmInput.addEventListener('input',function(){
            if (passwordInput.value !== passwordConfirmInput.value) {
                passwordConfirmInput.classList.add('is-invalid');
                passwordConfrimError.textContent = '';
            } else {
                passwordConfirmInput.classList.remove('is-invalid');
                passwordConfirmInput.classList.add('is-valid');
                passwordConfrimError.innerHTML = '<i class="fa fa-check" aria-hidden="true"></i>';h
            }
          });
        </script>
        </div>
